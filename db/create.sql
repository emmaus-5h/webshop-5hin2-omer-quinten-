...
insert into products (name, description, code, price, rating_id) values ('Adidas Voetbalschoen X Speedportal.1 FG Zwart Heren', 'De Adidas Voetbalschoen X Speedportal.1 FG voor heren is een state-of-the-art voetbalschoen die is ontwikkeld voor spelers die streven naar ultieme prestaties op het veld. Met een gestroomlijnd en aerodynamisch ontwerp is deze schoen ontworpen om maximale snelheid te leveren en tegelijkertijd optimale controle te behouden over de bal.', '492662', 150.00, 12);
insert into products (name, description, code, price, rating_id) values ('Nike Zoom Mercurial Vapor 15 Academy XXV Veterloze Gras / Kunstgras Voetbalschoenen (MG)', ' De Nike Zoom Mercurial Vapor 15 Academy XXV veterloze voetbalschoenen zijn een eerbetoon aan de 25e verjaardag van de legendarische Mercurial-lijn, die bekend staat om zijn snelheid en wendbaarheid op het veld. Deze schoenen zijn ontworpen om de prestaties van spelers te verbeteren, met name op gras- en kunstgrasvelden.', '492662', 51.00, 3);
insert into products (name, description, code, price, rating_id) values ('adidas Copa Mundial Voetbalschoenen', ' De Adidas Copa Mundial voetbalschoenen zijn een tijdloze klassieker die al tientallen jaren geliefd zijn bij voetballers vanwege hun uitzonderlijke comfort, duurzaamheid en prestaties op het veld. Deze schoenen zijn ontworpen met het oog op traditionele stijl en vakmanschap, gecombineerd met moderne technologieën om spelers een voorsprong te geven op het veld.', '492662', 180.00, 1);
insert into products (name, description, code, price, rating_id) values ('PUMA Future Play FG/AG Pursuit - Groen/Zwart/Turquoise', ' De PUMA Future Play FG/AG Pursuit voetbalschoenen zijn een geavanceerde keuze voor moderne voetballers die streven naar topprestaties op gras- en kunstgrasvelden. Het gestroomlijnde ontwerp van de schoenen biedt een perfecte combinatie van stijl en functionaliteit, met opvallende kleuren die opvallen op het veld.', '492662', 31.00, 4);
insert into products (name, description, code, price, rating_id) values ('Puma Vitoria FG voetbalschoenen zwart', ' De Puma Vitoria FG voetbalschoenen zijn ontworpen met het oog op duurzaamheid en prestaties. Het bovenwerk van de schoen is gemaakt van hoogwaardig synthetisch materiaal dat zorgt voor een comfortabele pasvorm en een uitstekende balcontrole. De zwarte kleurstelling geeft de schoenen een tijdloze uitstraling die past bij elke voetbaloutfit.', '492662', 45.00, 3);
